...
otcdocs_repo_name = 'opentelekomcloud-docs-swiss/key-management-service'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/key-management-service/api-ref/'
...
html_title = "Key Management Service - API Reference"
